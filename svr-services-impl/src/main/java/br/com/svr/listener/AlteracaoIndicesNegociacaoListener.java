...
*/public class AlteracaoIndicesNegociacaoListener implements MessageListener {
	...
	public void onMessage(Message mensagem) {
		...
		try {
			...
			log.log(Level.SEVERE, "Falha na recuperacao do indice de quantidade para alterar os indices das negociacoes", e);
		}

		if (idCliente != null && indiceQuantidade != null && indiceValor != null) {
			negociacaoService.alterarNegociacaoAbertaIndiceConversaoValorByIdCliente(idCliente, indiceQuantidade, indiceValor);
		}
		else {
			log.warning("A alteracao dos indices das negociacoes nao foi possivel. Os parametros sao: idCliente=" + idCliente + "; indiceQuantidade="
					+ indiceQuantidade + "; indiceValor=" + indiceValor);
		}
	}
