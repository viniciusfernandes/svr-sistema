...
/**
 * Classe responsvel por montar a barra de menu de opcoes. Sera executada apenas um vez ja que os
 * links do menu vao injetar as paginas em uma frame contudo no corpo da pagina principal.
 */
@Resource
public class MenuController extends AbstractController {
	...
	public MenuController(Result result, UsuarioInfo usuarioInfo) {
		...
		verificarPermissaoAcesso("acessoRelatorioComissaoVendedorPermitido", ADMINISTRACAO, CADASTRO_PEDIDO_VENDAS, OPERACAO_CONTABIL);
